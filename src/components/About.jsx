...
const About = () => {
  return (
    <>
      ...
      >
        I'm a skilled electronics engineer with experience in Python, C / C++, Matlab, JavaScript with expertise in frameworks such as React, Three.JS, Pandas, MatPlotLib, Selenium. I am also a quick learner and can collaborate closely with clients to create efficient, scalable, and user-friendly solutions that solve real-world problems. Let's work together to bring your ideas to life!
      </motion.p>
